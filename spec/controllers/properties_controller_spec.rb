...
describe PropertiesController do
  ...
  context "POST create" do
    ...
    it "allows only admin" do
      ...
      Property.last.destination_id.should == @destination.id
    end
  end
...
#   let(:valid_attributes) { FactoryGirl.build(:property).attributes }
...
#         post :create, {:property => { "destination_id" => "invalid value" }}, valid_session
#         assigns(:property).should be_a_new(Property)
#       end
...
#         Property.any_instance.should_receive(:update).with({ "destination_id" => "1" })
#         put :update, {:id => property.to_param, :property => { "destination_id" => "1" }}, valid_session
#       end
...
#         # Trigger the behavior that occurs when invalid params are submitted
#         Property.any_instance.stub(:save).and_return(false)
#         put :update, {:id => property.to_param, :property => { "destination_id" => "invalid value" }}, valid_session
#         assigns(:property).should eq(property)
#       end
