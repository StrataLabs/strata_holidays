...
describe "vacation_consultants/new" do
  before(:each) do
    assign(:vacation_consultant, stub_model(VacationConsultant,
      :name => "MyString",
      :address_1 => "MyString",
      :address_2 => "MyString",
      :city => "MyString",
  ...
  it "renders new vacation_consultant form" do
    render

    # Run the generator again with the --webrat flag if you want to use webrat matchers
    assert_select "form[action=?][method=?]", vacation_consultants_path, "post" do
