...
describe "vc_registrations/new" do
  before(:each) do
    assign(:vc_registration, stub_model(VcRegistration,
      :name => "MyString",
      :address => "MyString",
      :city => "MyString",
      :state => "MyString",
  ...
  it "renders new vc_registration form" do
    render

    # Run the generator again with the --webrat flag if you want to use webrat matchers
    assert_select "form[action=?][method=?]", vc_registrations_path, "post" do
