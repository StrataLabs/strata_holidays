...
ActiveRecord::Schema.define(version: 20131122114901) do
  ...
  add_index "cust_iti_detail_versions", ["item_type", "item_id"], name: "index_cust_iti_detail_versions_on_item_type_and_item_id"
  ...
  add_index "cust_iti_header_versions", ["item_type", "item_id"], name: "index_cust_iti_header_versions_on_item_type_and_item_id"
  ...
  add_index "poa_detail_versions", ["item_type", "item_id"], name: "index_poa_detail_versions_on_item_type_and_item_id"
